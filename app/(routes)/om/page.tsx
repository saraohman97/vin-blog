...
const AboutPage = () => {
  return (
    <div className="relative bg-white">
      ...
      />
      <div className="absolute h-[800px] inset-0 flex flex-col items-center justify-center max-w-screen-lg mx-auto text-center">
        <h1 className="text-6xl md:text-7xl font-serif font-bold text-white pb-20">
          Bakom kuliserna
        </h1>
      </div>

      {/* ABOUT SECTION */}
      <div className="p-10 grid grid-cols-1 gap-10 items-center max-w-screen-sm mx-auto text-center">
        <div className="px-10 pt-10">
          ...
          <div className="text-red-900 text-sm text-start flex flex-col items-center mt-6 cursor-pointer">
